...
def run():
    # Global Styles
    BACKGROUND_COLOR = "#FFFFFF"  # Background color for the main app
    ...
    # Function to calculate surebet results
    ...
    if market_type == "2-Way Market":
        ...
        with col1:
            odd1 = st.number_input("Kaizen Odds", min_value=1.01, value=2.0, step=0.01, key="odd1")
        with col2:
            odd2 = st.number_input("Competition Odds", min_value=1.01, value=2.0, step=0.01, key="odd2")
        odds = [odd1, odd2]
        ...
        with col1:
            odd1 = st.number_input("Kaizen Odds", min_value=1.01, value=2.0, step=0.01, key="odd1")
        with col2:
            odd2 = st.number_input("Competition 1 Odds", min_value=1.01, value=2.5, step=0.01, key="odd2")
        with col3:
            odd3 = st.number_input("Competition 2 Odds", min_value=1.01, value=3.0, step=0.01, key="odd3")
        odds = [odd1, odd2, odd3]
        ...
        with col3:
            odd3 = st.number_input("Competition 2 Odds", min_value=1.01, value=3.0, step=0.01, key="odd3")
        with col4:
            odd4 = st.number_input("Competition 3 Odds", min_value=1.01, value=4.0, step=0.01, key="odd4")
